...
const OfficerDashboard = () => {
  ...
  const handleVerify = (id: string, type: 'police' | 'officer') => {
    try {
      if (type === 'officer') {
        const updatedApplication = db.updateApplication(id, { officerVerified: true });
        ...
        if (updatedApplication) {
          ...
          toast({
            ...
            description: "The passport application has been verified by passport officer"
          });
        }
      }
    } catch (error) {
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6">Passport Officer Dashboard</h1>
      
      <Card className="mb-8">
        <CardHeader>
          <CardTitle>Passport Applications</CardTitle>
          <CardDescription>
            Review and verify passport applications
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-6">
